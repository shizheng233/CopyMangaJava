...
public class ImageUtil {
     ...
     *
     * @param sentBitmap bimap
     * @param radius num
     * @param canReuseInBitmap canReuseInBitmap
     * @return new bitmap
     */
...
//            Log.d("tag", "r=" + red + ",g=" + green + ",b=" + blue);
    ...
    //删选出色值并赋值给imageview
    public static int getOneColor(Bitmap bitmap){
        ArrayList<Integer> picturePixel = ImageUtil.getPicturePixel(bitmap);
