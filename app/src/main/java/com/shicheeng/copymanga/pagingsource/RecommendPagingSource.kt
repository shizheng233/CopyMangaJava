...
import com.shicheeng.copymanga.json.MangaRecommendJson

class RecommendPagingSource : PagingSource<Int, ListBeanManga>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, ListBeanManga> {
        return try {
            ...
            val responseData = MangaRecommendJson.mangaRecommendList(nextPageNumber)
