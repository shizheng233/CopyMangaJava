...
fun SettingScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                ...
                navigationIcon = {
                    PlainTooltipBox(
                        tooltip = {
                            Text(text = stringResource(id = R.string.back_to_up))
                        }
                    ) {
                        IconButton(
                            ...
                            Icon(
                                ...
                                contentDescription = stringResource(id = R.string.back_to_up)
                            )
                        }
                    }
                },
        ...
        LazyColumn(
            ...
            item {
                val array1 = rememberSaveable { resource.getStringArray(R.array.orientation_array) }
                ListPreference(
