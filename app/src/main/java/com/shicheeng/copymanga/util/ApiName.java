...
public class ApiName {
    ...
    private static final String mangaSearch = " https://api.copymanga.net/api/v3/search/comic?format=json&limit=21&offset=%s&platform=3&q=%s";
     ...
     * @return 总api
     */
    public static String mangaSearchApi(String name, int offset) {
